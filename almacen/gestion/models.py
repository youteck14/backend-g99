...
class DepartamentoModel(models.Model):
    ...
    #si nostros no declaramos el Autofield Django de manera
    #predeterminada creara una columna llamada 'id' que sea autoincrementable
    #https://docs.djangoproject.com/en/4.1/ref/models/fields/
    #https://docs.djangoproject.com/en/4.1/ref/models/fields/#field-options
    #las opciones que le puedo colocar a todas las columnas
    id = models.AutoField(primary_key=True, unique=True, null=False)
    nombre = models.CharField(max_length=50, null=False)
    codigoPostal = models.CharField(max_length=10,unique=True, db_column='codigo_postal')

    class Meta:
        #pasarle metadata a informacion adicional a la clase de la cual estamos heredando
...
class AlmacenModel(models.Model):
    ...
    #on delete > se guardara la informacion de como debe actuar el almacen si es que se elimina el departamento (el registro con ese modelo)
    ...
    departamento = models.OneToOneField(to=DepartamentoModel, on_delete=models.CASCADE, db_column='deparamento_id')
