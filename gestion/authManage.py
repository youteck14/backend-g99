...
class UsuarioManager(BaseUserManager):
    ...
    def create_superuser(self, correo, nombre, apellido, tipoUsuario, password):
        ...
        #la siguiente configuracion seria si aun queremos utiliar el panel administrativo
        ...
        #de momento el self._db estara vacio por lo que usara la conexion a la base de datos por defecto, caso contrario si tuviesemos mas de una conexion a alguna bd entonces indicariamos a que bd quremos conectarnos
